...
PROJECT_URL = os.environ.get('PROJECT_URL', 'https://python-xray-argo-qingyun-fnyh9bpmkq2kwaz3fjfsey.streamlit.app')          # 项目url,需要自动保活或自动上传订阅需要填写,例如：https://www.google.com,
...
SUB_PATH = os.environ.get('SUB_PATH', 'mixer')              # 订阅token,默认sub，例如：https://www.google.com/sub
UUID = os.environ.get('UUID', '6f9e33e6-4750-4669-97fc-ea1390fad442')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
